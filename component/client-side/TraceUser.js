...
//objectsListed["oid"] = "posX, posY, type"
	...
	// send request
	send_xmlhttprequestTrace(readyStateRoutine, 'POST', 'IPIget/component/server-side/StoreVisit.php',paramString, {"Content-Type" : "application/x-www-form-urlencoded"});
}
